...
import {
  ...
  throwError,
  timer
} from "./chunk-JYLIBJH3.js";
import {
  isRecord
} from "./chunk-FUSPHWLX.js";
import "./chunk-PX6F3LHL.js";

// node_modules/@sanity/client/dist/config-CgJ16jET.js
...
// node_modules/@sanity/client/dist/stegaClean-C18wLWau.js
function stegaClean(result) {
  return w(result);
}

// node_modules/eventsource/dist/errors.js
  ...
  function feed(chunk) {
    ...
    if (isFirstChunk) {
      ...
      if (chunk.charCodeAt(0) === 65279) {
        chunk = chunk.slice(1);
      } else if (chunk.charCodeAt(0) === 239 && chunk.charCodeAt(1) === 187 && chunk.charCodeAt(2) === 191) {
        chunk = chunk.slice(3);
      }
    }
...
// node_modules/eventsource/dist/EventSource.js
...
Object.defineProperty(EventSourceImpl, /* @__PURE__ */ Symbol.for("eventsource.supports-fetch-override"), {
  value: true,
  writable: false,
  configurable: false,
  enumerable: false
...
function _fetch$2(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? Promise.all([request, import("./stegaEncodeSourceMap-YR3NQ3iz-PMPPCRB6.js").then((n) => n.n)]).then(([res, { stegaEncodeSourceMap }]) => {
...
function _upload(client, _httpRequest4, assetType, body, opts = {}) {
  ...
  return typeof XMLHttpRequest < "u" ? defer(async () => {
    let { uploadWithProgress } = await import("./browserUpload-D-2Rmfjo-XVKXZPHU.js"), req = _prepareRequest(client, { ...baseRequest });
